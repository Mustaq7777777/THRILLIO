...
public class DataStore {
	...
	public static final int USER_BOOKMARKS_LIMIT = 5;
	...
	private static UserBookmark[] userBookmarks = new UserBookmark[TOTAL_USERS_COUNT * USER_BOOKMARKS_LIMIT];
	...
	private static void loadMovies() {
		...
		bookmarks[1][0] = BookmarkManager.getInstance().createMovie(3000, "Citizen Kane", 1941,
				...
				8.5);
		bookmarks[1][1] = BookmarkManager.getInstance().createMovie(3000, "The Grapes of Wrath", 1940,
				new String[] { "Henry Fonda", "Jane Darwell" }, new String[] { "John Ford" }, MovieGenre.CLASSICS, 8.2);
		bookmarks[1][2] = BookmarkManager.getInstance().createMovie(3000, "A Touch of Greatness", 2004,
				new String[] { "Albert Cullum" }, new String[] { "Leslie Sullivan	Documentaries" },
